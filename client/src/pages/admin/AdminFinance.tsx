...
import { DollarSign, TrendingUp, ShoppingCart, ListChecks, ArrowDown, Printer } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="lg:mr-72 lg:p-8 ml-0 p-4 transition-all duration-300">
                <h1 className="text-3xl font-bold mb-8">المالية والجرد</h1>
                            ...
                            <Card className="bg-gray-50 border-gray-100">
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex justify-between items-center border-b pb-2">
                                        ...
                                        {/* Note: Logic for count is hypothetical here as fetching product count needs a specific query or use fetched products length if available. 
                          I'll avoid direct product fetch here to keep it light, relying on valuation query if improved later. 
                          For now just showing valuation is key. */}
